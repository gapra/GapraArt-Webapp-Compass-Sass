# GapraArt - Web app, Compass with Sass [![Build Status](https://secure.travis-ci.org/yeoman/generator-webapp.svg?branch=master)](http://travis-ci.org/yeoman/generator-webapp)

Build with [Yeoman](http://yeoman.io) generator that scaffolds out a front-end web app.
...
## Getting Started working with Yeoman webapp
...
Example site build with Compass, Sass on Yeoman webapp
[GapraArt Site] (http://www.gapraart.com).
